  ...
  return (
    <header className="bg-white fixed w-full top-0 z-50">
      ...
      >
        <div className="flex flex-col lg:flex-1">
          <a href="#" className="-m-1.5 p-1.5">
            ...
            <HeartPulse className="text-blue-700 h-12 w-12" />
          </a>
        </div>
      ...
      >
        ...
        <DialogPanel className="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-gray-50 px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
          <div className="flex items-center justify-between">
            ...
            >
              ...
              <XMarkIcon aria-hidden="true" className="h-6 w-6 text-gray-800" />
            </button>
          </div>
