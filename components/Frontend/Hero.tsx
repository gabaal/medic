              ...
              <div className="hero-content">
                ...
                <ul className="flex flex-wrap items-center mt-6">
                  ...
                  <li>
                    <a
                      href="/#"
                      className=" rounded-md inline-flex items-center justify-center px-5 py-3 text-center text-base font-medium text-gray-50 hover:text-blue-500 dark:text-white"
                    >
                      <span className="mr-2">
                        <svg
                          width="24"
