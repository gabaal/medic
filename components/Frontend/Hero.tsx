            ...
            <div className="w-full px-4 lg:w-6/12">
              <div className="hero-content">
                ...
                <p className="mb-8 max-w-[480px] text-base text-gray-100 dark:text-gray-50-6">
                  ...
                  red tape to bring you simple, affordable, and transparent
                  healthcare.
                </p>
                ...
                <ul className="flex flex-wrap items-center mt-6">
                  <li>
                    <a
                      href="/#"
                      className=" inline-flex items-center justify-center rounded-lg bg-blue-600 px-6 py-3 text-center text-base font-medium text-white hover:bg-blue-700 lg:px-7"
                    >
                      Need a practitioner urgently
                    </a>
                  </li>
                  <li>
                    <a
                      href="/#"
                      className="border rounded-lg inline-flex items-center justify-center px-5 py-3 text-center text-base font-medium text-gray-50 hover:text-blue-500 dark:text-white"
                    >
                      <span className="mr-2">
                ...
                <div className="py-4 pt-8 text-center justify-center flex gap-4">
                  <div className="flex flex-col items-center justify-center">
                    <span className="font-bold text-gray-50">107</span>
